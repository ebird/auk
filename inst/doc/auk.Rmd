...
The second is suitable for producing zero-filled, presence-absence data. It contains every sighting from Singapore in 2012 of Collared Kingfisher, White-throated Kingfisher, and Blue-eared Kingfisher. In addition to these sightings data, the full Sampling Event Data file is included containing all checklists from Singapore in 2012. These files can be accessed with:
